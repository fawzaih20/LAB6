...
AN1:Row: 1643  , Column: 6
NA2:Row it's about the Resturant name [more information about it] 
AN3:Column [address , city , state , zip , longitude , latitude]

2.  What are the dimensions of the La Quinta's dataset?
    What does each row in the dataset represent?
    What are the variables?
AN1:Row: 909 , Column: 6
AN2:Row it's about the Hotels name [more information about it] 
AN3:Column [address , city , state , zip , longitude , latitude]
...
AN1: Denny's the most= CA and the fewest= DE
AN2: La Quinta the most= TX and the fewest= AG
AN3:No , I'm not surpise Texas has the largest number,beause Texas is the second largest state in the United States.
